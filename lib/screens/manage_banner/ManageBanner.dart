...
class ManageBanner extends GetView<ManageBannerController> {
              ...
              widget: TabView(
                ...
                tabs: [
                  Tab(
                    ...
                    body: _buildBannerContainer(hit, wid, context),
                  ),
                  Tab(
                    text: Text(
                      'Request Banner',
                    ...
                    body: _buildRequestContainer(hit, wid),
                  ),
                ],
              ),
            ),
  ...
  Widget _buildBannerContainer(double hit, double wid, BuildContext context) {
    return Container(
      height: hit,
      width: wid,
      color: AppColor.white,
                                ...
                                children: [
                                  ...
                                  ListView.separated(
                                    ...
                                    separatorBuilder: (context, index) =>
                                        const Gap(20),
                                    itemCount: controller.type1.length,
                                  ),
                                  controller.type1.isEmpty
                                      ? const Gap(0)
                                      : const Gap(15),
                                  ...
                                  ListView.separated(
                                    ...
                                    separatorBuilder: (context, index) =>
                                        const Gap(20),
                                    itemCount: controller.type2.length,
                                  ),
                                  controller.type2.isEmpty
                                      ? const Gap(0)
                                      : const Gap(15),
                                  ...
                                  ListView.separated(
                                    ...
                                    separatorBuilder: (context, index) =>
                                        const Gap(20),
                                    itemCount: controller.type3.length,
                                  ),
                                ],
                              ),
                            ),
  ...
  Widget _buildRequestContainer(double hit, double wid) {
    return Container(
      height: hit,
      width: wid,
      color: AppColor.white,
